...
export default function Home() {
  ...
  className="absolute left-0 right-0 top-16 w-full h-[calc(100%-3.5rem)] bg-white dark:bg-zinc-800/95 z-50 p-4 pt-6 rounded-2xl backdrop-blur-md shadow-2xl flex flex-col"
