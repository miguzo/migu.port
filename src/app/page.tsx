...
export default function Home() {
  ...
  useEffect(() => { document.body.style.overflow = panelOpen ? "hidden" : "" }, [panelOpen])
  useEffect(() => { setCurrentTracks(projects[projectIdx].tracks) }, [projectIdx])
  useEffect(() => {
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex gap-1">
                      ...
                      >
                        ...
                        <svg width="13" height="13" viewBox="0 0 14 14" stroke="currentColor" fill="none"><path d="M2 2l10 10m0-10L2 12" strokeWidth="2" strokeLinecap="round"/></svg>
                      </button>
                    </div>
                  </div>
                  {/* Panel content */}
...
function Card({
  ...
  onCardTouchStart: any, onCardTouchMove: any, onCardTouchEnd: any,
      ...
      >
        {(["listen","read","about","journal"] as const).map(tab=>(
          <button
            ...
            onKeyDown={e=>{if(isActive && (e.key==="Enter"||e.key===" ")){selectPanel(tab)}}}
            className={clsx(
