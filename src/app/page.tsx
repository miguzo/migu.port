...
export default function Home() {
  ...
  className="absolute left-0 right-0 top-16 w-full h-[calc(100%-3.5rem)] bg-white dark:bg-zinc-800/95 z-50 p-4 pt-2 rounded-2xl backdrop-blur-md shadow-2xl flex flex-col"
...
<div className="relative flex flex-col items-center w-full pb-5 pt-0 px-4 z-20" style={{ minHeight: 140 }}>
  {/* Title (move even closer to image by setting mt-0 and mb-1) */}
  <h2 className="text-base font-semibold text-black dark:text-white text-center mb-1 mt-0">
    {project.title}
  </h2>
